...
- Training completion toward planned run: `93.53%` (`2.806` / `3` epochs)
...
- Warmup steps: `5114`
- Weight decay: `0.01`
- Steps completed: `95645`
- Planned total steps: `102276`
- Images seen: `765240`
- Total training time: `22.1894` hours
- Hardware: `NVIDIA GeForce RTX 5070`
- Final train loss: `1.8346`
...
| RadGraph F1 | `0.0893` |
| RadGraph entity F1 | `0.1363` |
| RadGraph relation F1 | `0.1218` |
| CheXpert F1 14-micro | `0.1774` |
| CheXpert F1 5-micro | `0.2064` |
| CheXpert F1 14-macro | `0.1060` |
| CheXpert F1 5-macro | `0.1545` |
