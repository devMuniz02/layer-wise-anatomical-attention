...
- Training completion toward planned run: `3.86%` (`0.116` / `3` epochs)
...
- CheXpert F1 micro: `0.2443`
- CheXpert F1 macro: `0.1641`
- RadGraph F1: `0.0953`
- RadGraph entity F1: `0.1415`
- RadGraph relation F1: `0.1301`
